...
- 原版下载
- Forge 下载 + 静默安装
- 原版 + Forge 启动（inheritsFrom 合并）
- 实时显示日志

修复了 v2.5 的两个 bug：
1. MainWindow.log 是普通方法，不能 .emit
2. ForgeInstallWorker 传 pyqtSignal 对象，内部无法调用
"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("DHML 启动测试 v2.6")
